...
public class AlcoholEtherSlotsPanel extends JPanel {
	...
	//sounds variables
	private File clickSound2;
	private File winSlot2;
	
	private AudioInputStream createClick2;
	private AudioInputStream createWin2;
	
	private Clip startSound2; 
	private Clip winSound2;
	//integer variables
		...
		public void actionPerformed(ActionEvent event){
			...
			if(event.getSource()==button){
				...
				try {
					...
					try {
						startSound2 = AudioSystem.getClip();
